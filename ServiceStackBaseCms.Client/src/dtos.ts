...
export class QueryResponse<Todo> {
    ...
    public constructor(init?: Partial<QueryResponse<Todo>>) {
        (Object as any).assign(this, init);
    }
}
...
export class QueryTodos
    extends QueryData<Todo>
    implements IReturn<QueryResponse<Todo>>
{
    public id?: number;
    public ids?: number[];
...
export class CreateTodo implements IReturn<Todo>, IPost {
    ...
    public constructor(init?: Partial<CreateTodo>) {
        (Object as any).assign(this, init);
    }
    public getTypeName() {
...
export class UpdateTodo implements IReturn<Todo>, IPut {
    ...
    public constructor(init?: Partial<UpdateTodo>) {
        (Object as any).assign(this, init);
    }
    public getTypeName() {
...
export class DeleteTodo implements IReturnVoid, IDelete {
    ...
    public constructor(init?: Partial<DeleteTodo>) {
        (Object as any).assign(this, init);
    }
    public getTypeName() {
...
export class DeleteTodos implements IReturnVoid, IDelete {
    ...
    public constructor(init?: Partial<DeleteTodos>) {
        (Object as any).assign(this, init);
    }
    public getTypeName() {
        return "DeleteTodos";
