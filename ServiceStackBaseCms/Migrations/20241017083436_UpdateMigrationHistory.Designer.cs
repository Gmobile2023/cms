...
namespace ServiceStackBaseCms.Migrations
{
    ...
    [Migration("20241017083436_UpdateMigrationHistory")]
    partial class UpdateMigrationHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceStackBaseCms.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ServiceStackBaseCms.Data.ApplicationUser", null)
                        .WithMany()
