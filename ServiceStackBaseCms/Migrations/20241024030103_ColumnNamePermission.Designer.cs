...
namespace ServiceStackBaseCms.Migrations
{
    ...
    [Migration("20241024030103_ColumnNamePermission")]
    partial class ColumnNamePermission
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServiceStackBaseCms.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("ServiceStackBaseCms.Domain.Entities.EndpointPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_endpoint_permissions");

                    b.ToTable("endpoint_permissions", "public");
                });

            modelBuilder.Entity("ServiceStackBaseCms.Domain.Entities.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ServiceStackBaseCms.Domain.Entities.Todo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ServiceStackBaseCms.Domain.Entities.RoleClaims", b =>
                {
            ...
            modelBuilder.Entity("ServiceStackBaseCms.Domain.Entities.UserClaims", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ServiceStackBaseCms.Domain.Entities.ApplicationUser", null)
                        .WithMany()
